...
// generated-by-copilot: updated to support optional comment when adding a favorite
export const addFavorite = createAsyncThunk('favorites/addFavorite', async ({ token, bookId, comment = '' }) => {
